...
function barbershop_booking_step1_prestation() {
    ...
    $staff_id    = isset($_GET['bs_staff']) ? intval($_GET['bs_staff']) : null;
                        ...
                        <div class="bs-booking-prestation-list">
                            <?php while ($prestations->have_posts()) : $prestations->the_post(); ?>
                                ...
                                $url = add_query_arg([
                                    'bs_step'       => 2,
                                    'bs_prestation' => $pid,
                                    'bs_staff'      => !empty($allowed_staff_ids) && $staff_id == null ? $allowed_staff_ids[0] : $staff_id,
                                ], $current_url);
                                ?>
...
function barbershop_booking_step3_summary_and_form($prestation_id, $staff_id, $date, $time) {
    ...
    if( $staff === null ){
        echo '<p>Prestataire introuvable.</p>';
        return;
    }
